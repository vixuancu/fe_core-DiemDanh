...
import { ThuThapVideoSinhVienPage } from "@/app/components/thu-thap-video-sinh-vien-page";
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "diem-danh", element: <DiemDanhWebcamPage /> },
          {
            ...
            element: <ThuThapVideoSinhVienPage />,
          },
          ...
          // ── Admin + Giáo vụ ──────────────────────────────────────────────
          {
            ...
            children: [
              ...
              {
                path: "lop-tin-chi/:lopTinChiId/sinh-vien",
                element: <LopTinChiSinhVienPage />,
              },
          ...
          {
            element: (
              <RoleGuard allowedRoles={["admin", "giao_vu", "giang_vien"]} />
            ),
            children: [
