    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="bg-white rounded-xl p-6 border border-border">
        ...
        <div className="flex justify-end gap-2 mt-6">
          <button className="px-4 py-2 rounded-lg border border-border text-sm hover:bg-muted cursor-pointer">Hủy</button>
          <button className="px-4 py-2 rounded-lg bg-[#009dd9] text-white text-sm hover:bg-[#0088be] cursor-pointer">Đổi mật khẩu</button>
        </div>
      </div>
    </div>
  );
