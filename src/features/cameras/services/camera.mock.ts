...
import { mockCamera, mockTaiKhoan } from '@/app/components/data';
import { Camera } from '../types';

let STORE: Camera[] = [...mockCamera] as Camera[];

const delay = (ms = 300) => new Promise((r) => setTimeout(r, ms));

export const cameraMock: ICameraService = {
    async getCameras({ }: CameraFilter): Promise<PaginatedResult<Camera>> {
        await delay();
