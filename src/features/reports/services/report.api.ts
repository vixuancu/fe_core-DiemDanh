...
export const reportApi: IReportService = {
  async getStats(filter: ReportFilter): Promise<ReportStatsResponse> {
    ...
    if (filter.course_section_id)
      params.append("course_section_id", filter.course_section_id);
    if (filter.from_date) params.append("from_date", filter.from_date);
    if (filter.to_date) params.append("to_date", filter.to_date);

    const res = await fetch(`${config.apiBaseUrl}/reports/stats?${params}`, {
      headers: getHeaders(),
    });
  ...
  async getOverview(): Promise<ReportOverviewResponse> {
    const res = await fetch(`${config.apiBaseUrl}/reports/overview`, {
      headers: getHeaders(),
    });
    const response = await handleResponse<any>(res);
    return response.data;
  ...
  async getWeeklyTrend(filter: ReportFilter): Promise<WeeklyTrendItem[]> {
    ...
    const res = await fetch(
      `${config.apiBaseUrl}/reports/weekly-trend?${params}`,
      { headers: getHeaders() },
    );
    const response = await handleResponse<any>(res);
    return response.data;
  ...
  async getClassSummary(filter: ReportFilter): Promise<ClassSummaryItem[]> {
    ...
    const res = await fetch(
      `${config.apiBaseUrl}/reports/class-summary?${params}`,
      { headers: getHeaders() },
    );
    const response = await handleResponse<any>(res);
    return response.data;
  ...
  async getDetails(
    ...
    const res = await fetch(`${config.apiBaseUrl}/reports/details?${params}`, {
      headers: getHeaders(),
    });
    const response = await handleResponse<any>(res);
