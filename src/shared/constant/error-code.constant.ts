export const ERROR_MESSAGES: Record<string, string> = {
    ...
    'CLASS_NAME_IS_EXISTED': 'Tên lớp học này đã tồn tại trong hệ thống.',
    ...
    'CAMERA_NAME_IS_EXISTED': "Tên camera đã tồn tại",
    'IP_ADDRESS_IS_EXISTED': "Địa chỉ IP đã tồn tại",
